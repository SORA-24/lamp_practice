...
item_id`,
`name
`, `stock`, `price`, `image`, `status`, `created`, `updated`) VALUES
...
(20) NOT NULL,
  `type` int
(11) NOT NULL DEFAULT '2',
  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON
UPDATE CURRENT_TIMESTAMP,
  `updated
...
user_id`,
`name
`, `password`, `type`, `created`, `updated`) VALUES
...
(`item_id`) ON
DELETE CASCADE,
ADD CONSTRAINT `carts_ibfk_2` FOREIGN KEY
